    ...
    return(
                <div className="w-full">
                    ...
                    <form onSubmit={handleSubmit} className='p-lg:p-5 w-full'>
                        ...
                        <div
                            className="relative z-0 w-full mb-6 group">
                            <textarea defaultValue={message}  onChange={(e)=>setMessage(e.target.value)} rows={5} name="messagee"  className="resize-none block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required ></textarea>
