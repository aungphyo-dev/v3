const Experience = () => {
    return (
        <div className=' pt-[25px]  lg:pt-[65px]' id='experience'>
                    ...
                    <div
                        ...
                        <div className="z-10 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal text-[#5eead4]">
                                I work at  <a target="blank" className='hover:underline text-blue-500' rel="noreferrer" href="https://codewalltechnologies.com">
                                Codewall Technologies
                            </a> in July 1, 2023 as Frontend developer.
                            </p>
                            <ul className="mt-2 flex flex-wrap">
                                ...
                                <li className="mr-1.5 mt-2">
                                    <div
                                        className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">SCSS
                                    </div>
                                </li>
                                <li className="mr-1.5 mt-2">
                                    <div
                ...
                <li className="mb-12 cursor-pointer">
                    <div
                        ...
                        <div className="z-10 sm:col-span-6">
                            ...
                            <p className="mt-2 text-sm leading-normal text-[#5eead4]">
                                I work as Frontend developer <a target="blank" className='hover:underline text-blue-500' rel="noreferrer" href="https://www.linkedin.com/">
                                Linkedin
                            </a> and <a target="blank" className='hover:underline text-blue-500' rel="noreferrer" href="https://www.upwork.com/">
                                Upwork
                            </a> in 2023 .
                            </p>
                            <ul className="mt-2 flex flex-wrap">
                                ...
                                <li className="mr-1.5 mt-2">
                                    <div
                                        className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Laravel
                                    </div>
                                </li>
                            </ul>
                        </div>
